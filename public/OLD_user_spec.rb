...
describe User do
 ...
 it "should create a new instance given a valid attribute" do
  ...
  # NOTE: This is the code fom the web book - it doesn't work.
  ...
  describe "microposts associations" do
    ...
    it "should be in the reverse order of appearing" do
      # NOTE: This is the code from http://stackoverflow.com/questions/4526735/rails-3-tutorial-rspec-factory-girl-rails-problem
      @user.microposts.should == [@mp2, @mp1]
    end
